...
public class Experiment {
    ...
    public int variantsRandomlyOrdered; // for example, if there are 3 variants, this might be 231, 312, 123, etc. The numbers are the variant indexes

    @JsonCreator
    public Experiment(@JsonProperty("name") String name, @JsonProperty("active") boolean active, @JsonProperty("conditions") ExperimentCondition[] conditions, @JsonProperty("variants") ExperimentVariant[] variants, @JsonProperty("trigger") ExperimentTrigger trigger, @JsonProperty("id") String id, @JsonProperty("consistentVariantForUuid") boolean consistentVariantForUuid, @JsonProperty("variantsRandomlyOrdered") int variantsRandomlyOrdered) {
        this.name = name;
        this.active = active;
